      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            ...
            <span className={landingPageStyles.logoText}>Rezoom</span>
          </div>
          {/* Middle Menu Button */}
          <button
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                A professional web application that enables users to efficiently
                design, customize, and export polished, industry-standard
        ...
        <footer className={landingPageStyles.footer}>
          <div className={landingPageStyles.footerContainer}>
            <p className={landingPageStyles.footerText}>
              ...
              <span className={landingPageStyles.footerText}>Rezoom</span>
            </p>
          </div>
        </footer>
      </main>
